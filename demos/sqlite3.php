 ...
 */
	...
	echo '<p>Using SQLite3 driver</p>';
	// create new UniDB object, providing the type of driver as argument (defined in config)
	$db = new UniDB( 'sqlite3' );
	
	// tell the driver to use .sqlite filename extension, instead of the default (.db)
	// you can provide any other extension, just remember to add . before it
	// PLEASE NOTE: this must be called before 'connect' or 'select_db', otherwise it will not work
	$db->set_option('file_ext', '.sqlite3');
